    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 p-8">
        <div className="glass-panel border border-white/5 rounded-xl p-8 flex flex-col items-center justify-center h-64 text-center">
          ...
          <h3 className="text-[#EAEAEA] font-semibold text-lg mb-2">Services Hub</h3>
          <p className="text-[#888888] text-sm max-w-md leading-relaxed">
            Sandra orchestrates across the vendor ecosystem you already use. Whether you rely on specific identity verification providers, specialized fraud intelligence tools, or existing transaction monitoring software, Sandra unifies these third-party services into a single operational view without replacing them.
          </p>
        </div>
      </div>
    </div>
