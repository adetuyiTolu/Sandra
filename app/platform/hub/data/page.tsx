    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 p-8">
        <div className="glass-panel border border-white/5 rounded-xl p-8 flex flex-col items-center justify-center h-64 text-center">
          ...
          <h3 className="text-[#EAEAEA] font-semibold text-lg mb-2">Data Hub</h3>
          <p className="text-[#888888] text-sm max-w-md leading-relaxed">
            This is where Sandra ingests intelligence. From secure internal data warehouses to global sanctions watchlists, government registries, and credit bureaus, Sandra continuously reads and cross-references data to fuel its AI-driven compliance decisions, meeting your data exactly where it lives.
          </p>
        </div>
      </div>
    </div>
