    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 p-8">
        <div className="glass-panel border border-white/5 rounded-xl p-8 flex flex-col items-center justify-center h-64 text-center">
          ...
          <h3 className="text-[#EAEAEA] font-semibold text-lg mb-2">Core Hub</h3>
          <p className="text-[#888888] text-sm max-w-md leading-relaxed">
            This is how Sandra connects directly to your company's foundation. By integrating with your Core Banking systems, CRMs, and ERPs, Sandra reads from your existing infrastructure and orchestrates actions seamlessly without requiring you to rip out or replace any of your critical operational software.
          </p>
        </div>
      </div>
    </div>
