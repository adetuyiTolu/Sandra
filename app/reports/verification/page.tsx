    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 p-8">
        <div className="glass-panel border border-white/5 rounded-xl p-8 flex flex-col items-center justify-center h-64 text-center">
          ...
          <h3 className="text-[#EAEAEA] font-semibold text-lg mb-2">Verification Hub</h3>
          <p className="text-[#888888] text-sm max-w-md">
            This operational dashboard connects to your existing systems. Sandra uses this space to orchestrate processes, log activities, and provide explainability.
          </p>
        </div>
      </div>
    </div>
