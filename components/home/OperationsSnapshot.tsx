...
export function OperationsSnapshot() {
    ...
    return (
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-sm font-semibold text-[#EAEAEA]">Operations Queue</h2>
  ...
  return (
    <div className="mb-8">
      ...
      <div className="glass-card rounded-xl p-4 hover:-translate-y-1 transition-all duration-300 shadow-premium">
